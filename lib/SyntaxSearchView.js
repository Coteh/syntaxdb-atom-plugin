...
export default class SyntaxSearchView extends View {
    static content() {
        ...
        this.div({class: "search-bar"}, () => {
            ...
            this.subview('searchBarEditorView', new TextEditorView({editor: searchBarEditor}));
    ...
    constructor(serializedState) {
        ...
        this.searchLabel.text("Enter a concept or a language (e.g. for loop in Java)");
    ...
    initialize() {
        ...
        this.subscriptions.add(atom.commands.add(this.element, {
            ...
            'core:cancel': (e) => {this.cancel(); e.stopPropagation();}
        }));
    ...
    */
    ...
    confirmed(searchText) {
        this.eventEmitter.emit('did-confirm-search', {searchText: searchText});
    }
    ...
    */
    ...
    setConfirmAction(callback) {
        ...
        this.confirmEvent = this.eventEmitter.on('did-confirm-search', callback);
    }
